...
they must all be interpolated, and a large amount of per-fragment memory limits
the number of fragments that can be in-flight at once.  Large numbers of
varyings shrink the number of vertices that can be stored in the post-transform
cache.  This can cause thrashing and severely affect the performance of vertex
shading.  So thinning the interface between vertex and fragment shading is
valuable.
